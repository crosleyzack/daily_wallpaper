...
pub fn set(args: &Args) -> Result<(), Error> {
    ...
    match args.os {
        ...
        OS::Windows => {
            // NOTE: this was generated by AI and no yet tested
            let script = format!(
                "Add-Type -TypeDefinition 'using System; using System.Runtime.InteropServices; public class WallpaperSystem {{ [DllImport(\"user32.dll\", SetLastError = true)] public static extern bool SystemParametersInfo(int uAction, int uParam, string lpvParam, int fuWinIni); }}'; [WallpaperSystem]::SystemParametersInfo(0x0014, 0, '{path}', 0x01 -bor 0x02)",
                path = args.wallpaper.display()
            );
            ...
            {
                Ok(_) => {}
                Err(e) => print!("unable to set wallpaper via powershell: {e}"),
            }
        }
        OS::Mac => {
            // NOTE: this was generated by AI and no yet tested
            ...
            {
                Ok(_) => {}
                Err(e) => print!("unable to set wallpaper via osascript: {e}"),
            }
        }
    }
    Ok(())
